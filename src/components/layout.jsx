...
import { Footer } from '../components/introduction.jsx'
        ...
        <header>
            <nav id="header">
                <a className="header-link" id="header-logo" href="/">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-house-door-fill" viewBox="0 0 16 16" style={{verticalAlign: 'baseline'}}>
